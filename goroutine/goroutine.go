...
func main() {
	...
	/*
		...
		Конкрентность (Concurrency) - это дизайн программы. Когда у нас есть несколько процессов, которые
		...
		(отключать выоплняющиеся от ядра процессора и заменять ил Runnable тредами). Этот подход называется
